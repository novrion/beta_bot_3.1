...
void pawn_captures(int square, int colour, U64 w_block, U64 b_block, vector<U64>& moves) {
...
void knight_captures(int square, int colour, U64 w_block, U64 b_block, vector<U64>& moves) {
...
void king_captures(int square, int colour, U64 w_block, U64 b_block, vector<U64>& moves) {
...
void bishop_captures(int square, int colour, U64 w_block, U64 b_block, vector<U64>& moves) {
...
void rook_captures(int square, int colour, U64 w_block, U64 b_block, vector<U64>& moves) {
...
void queen_captures(int square, int colour, U64 w_block, U64 b_block, vector<U64>& moves) {
